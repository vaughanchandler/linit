...
# Install ansible.posix and community.general collections (can't list installed collections in ansible < 2.10 so the install will be attempted on each run there).
